...
<section class="search-section text-center mb-4 row mx-auto">
    ...
    <div class="serach-box text-center shadow p-2 my-1 bg-body rounded">    
        <form action="{{ route('books.search', ['booksType' => $booksType]) }}" method="GET" class="text-center col-12 row" role="search">
...
<section class="all-products-view">
    ...
    @php $autocompleteRoute = route('books.autocomplete', ['booksType' => $booksType]) @endphp
